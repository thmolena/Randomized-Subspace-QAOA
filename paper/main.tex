...
The wheel contains its own evidence bundle and does not depend on the original
checkout.  Exact simulator
derivatives remain an explicit optional access model rather than a claimed
hardware primitive.
